...
const WhatsAppButton = ({ appointmentDetails, phoneNumber = "918861534739" }) => {
  const openWhatsApp = () => {
    ...
    // wa.me link requires number without + and spaces
  ...
  return (
    <button
      ...
      className="flex-1 bg-gradient-to-r from-green-500 to-green-600 text-white px-4 py-2.5 rounded-lg hover:opacity-90 cursor-pointer font-medium transition-all shadow-lg hover:shadow-xl flex items-center justify-center text-sm"
    >
