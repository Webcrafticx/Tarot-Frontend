...
const Navbar = () => {
  ...
  const handleLinkClick = (sectionId) => {
    setIsMenuOpen(false); // auto close on link click
  ...
  return (
    <Container className="pb-0">
      <nav className="bg-[#F0EDF0] rounded-t-4xl relative">
        <div className="max-w-screen mx-auto px-4 sm:px-6 py-1 lg:px-8">
          <div className="flex justify-between items-center h-16">
              ...
              <div className="hidden lg:block">
                <div className="flex items-center space-x-8">
                  <button
                    ...
                    className="text-[#66626A] hover:text-[#4A6FA5] text-sm font-medium transition-colors duration-200"
                  >
                    ABOUT
                  </button>
                  <button
            ...
            {/* Desktop CTA Button */}
            <div className="hidden lg:block border-solid border-[#4A6FA5] border-2 rounded-full p-1">
              <button
                onClick={() => handleLinkClick("services")}
                className="bg-gradient-to-r from-[#4A6FA5] to-[#7D4E7A] hover:from-[#3A5A8C] hover:to-[#6D3E69] cursor-pointer text-white px-6 py-2.5 rounded-full text-xs font-semibold tracking-wider transition-colors duration-200 uppercase"
              >
            ...
            <div className="lg:hidden">
              <button
                onClick={toggleMenu}
                className="inline-flex items-center justify-center p-2 rounded-md text-[#66626A] hover:text-[#4A6FA5] focus:outline-none"
              >
                <svg
          ...
          >
            <div className="px-4 pt-4 pb-6 space-y-6 bg-[#F0EDF0]">
              <button
                onClick={() => handleLinkClick("about")}
                className="block text-start text-[#66626A] hover:text-[#4A6FA5] text-md font-medium transition-colors duration-200"
              >
                ABOUT
              </button>
              <button
              ...
              <div className="pt-2">
                <button
                  onClick={() => handleLinkClick("services")}
                  className="w-full bg-gradient-to-r from-[#4A6FA5] to-[#7D4E7A] hover:from-[#3A5A8C] hover:to-[#6D3E69] text-white px-6 py-2.5 rounded-full text-sm font-semibold tracking-wider uppercase transition-colors duration-200"
                >
                  Book My Consultation
                </button>
              </div>
